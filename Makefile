...
## all includes
ALL_INCL = $(MPI_INCL) $(CUDA_INCL) $(BOOST_INCL) $(HDF5_INCL) $(MISC_INCL) $(TIFF_INCL) $(PAPI_INCL)
...
OBJECTS_FIT = $(OBJECTS_MAIN) hipgisaxs_fit.o fitting_steepest_descent.o
