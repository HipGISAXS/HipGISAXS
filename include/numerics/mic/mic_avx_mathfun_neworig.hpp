...
static const __m512i _pi32_sign_mask __attribute__((aligned(64))) = _mm512_set1_epi32(0x80000000);
static const __m512i _pi32_inv_sign_mask __attribute__((aligned(64))) = _mm512_set1_epi32(~0x80000000);
static const __m512i _pi32_0 __attribute__((aligned(64))) = _mm512_set1_epi32(0);
static const __m512i _pi32_1 __attribute__((aligned(64))) = _mm512_set1_epi32(1);
static const __m512i _pi32_2 __attribute__((aligned(64))) = _mm512_set1_epi32(2);
static const __m512i _pi32_4 __attribute__((aligned(64))) = _mm512_set1_epi32(4);
static const __m512i _pi32_inv1 __attribute__((aligned(64))) = _mm512_set1_epi32(~1);
static const __m512i _pi32_0x7f __attribute__((aligned(64))) = _mm512_set1_epi32(0x7f);
static const __m512i _pi32_ffff __attribute__((aligned(64))) = _mm512_set1_epi32(0xffffffff);

static const mic_m512_t _ps_1 __attribute__((aligned(64))) = _mm512_set1_ps(1.0f);
static const mic_m512_t _ps_0point5 __attribute__((aligned(64))) = _mm512_set1_ps(0.5f);
static const mic_m512_t _ps_0 __attribute__((aligned(64))) = _mm512_set1_ps(0.0f);
static const mic_m512_t _ps_exp_hi __attribute__((aligned(64))) = _mm512_set1_ps(88.3762626647949f);
static const mic_m512_t _ps_exp_lo __attribute__((aligned(64))) = _mm512_set1_ps(-88.3762626647949f);
static const mic_m512_t _ps_cephes_LOG2EF __attribute__((aligned(64))) = _mm512_set1_ps(1.44269504088896341f);
static const mic_m512_t _ps_cephes_exp_C12 __attribute__((aligned(64))) = _mm512_set1_ps(0.69314718056f);
static const mic_m512_t _ps_cephes_exp_p0 __attribute__((aligned(64))) = _mm512_set1_ps(1.9875691500E-4f);
static const mic_m512_t _ps_cephes_exp_p1 __attribute__((aligned(64))) = _mm512_set1_ps(1.3981999507E-3f);
static const mic_m512_t _ps_cephes_exp_p2 __attribute__((aligned(64))) = _mm512_set1_ps(8.3334519073E-3f);
static const mic_m512_t _ps_cephes_exp_p4 __attribute__((aligned(64))) = _mm512_set1_ps(1.6666665459E-1f);
static const mic_m512_t _ps_cephes_exp_p5 __attribute__((aligned(64))) = _mm512_set1_ps(5.0000001201E-1f);
static const mic_m512_t _ps_minus_cephes_DP1 __attribute__((aligned(64))) = _mm512_set1_ps(-0.78515625f);
static const mic_m512_t _ps_minus_cephes_DP2 __attribute__((aligned(64))) = _mm512_set1_ps(-2.4187564849853515625e-4f);
static const mic_m512_t _ps_minus_cephes_DP3 __attribute__((aligned(64))) = _mm512_set1_ps(-3.77489497744594108e-8f);
static const mic_m512_t _ps_minus_cephes_DP123 __attribute__((aligned(64))) = _mm512_set1_ps(-0.7853981633974483096156608f);
static const mic_m512_t _ps_sincof_p0 __attribute__((aligned(64))) = _mm512_set1_ps(-1.9515295891E-4f);
static const mic_m512_t _ps_sincof_p1 __attribute__((aligned(64))) = _mm512_set1_ps(8.3321608736E-3f);
static const mic_m512_t _ps_sincof_p2 __attribute__((aligned(64))) = _mm512_set1_ps(-1.6666654611E-1f);
static const mic_m512_t _ps_coscof_p0 __attribute__((aligned(64))) = _mm512_set1_ps(2.443315711809948E-005f);
static const mic_m512_t _ps_coscof_p1 __attribute__((aligned(64))) = _mm512_set1_ps(-1.388731625493765E-003f);
static const mic_m512_t _ps_coscof_p2 __attribute__((aligned(64))) = _mm512_set1_ps(4.166664568298827E-002f);
static const mic_m512_t _ps_cephes_FOPI __attribute__((aligned(64))) = _mm512_set1_ps(1.27323954473516f);
