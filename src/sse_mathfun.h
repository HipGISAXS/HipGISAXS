...
v4sf newsin_ps(v4sf x) {
  ...
  v4sf y = _mm_mul_ps(x, *(v4sf*)_ps_cephes_FOPI);

  v4si emm2 = _mm_cvttps_epi32(y);
  emm2 = _mm_add_epi32(emm2, *(v4si*)_pi32_1);
  emm2 = _mm_and_si128(emm2, *(v4si*)_pi32_inv1);
  y = _mm_cvtepi32_ps(emm2);
...
v4sf newcos_ps(v4sf x) {
  ...
  v4si emm0 = _mm_andnot_si128(emm2, *(v4si*)_pi32_4);
  emm0 = _mm_slli_epi32(emm0, 29);
...
void newsincos_ps(v4sf x, v4sf *s, v4sf *c) {
  v4sf sign_bit = _mm_and_ps(x, *(v4sf*)_ps_sign_mask);
  x = _mm_and_ps(x, *(v4sf*)_ps_inv_sign_mask);
